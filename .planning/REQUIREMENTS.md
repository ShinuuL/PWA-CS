...
- [x] **SPOT-01**: User can connect Spotify account via OAuth
- [x] **SPOT-02**: User can link a shared playlist to the app
- [x] **SPOT-03**: Player card shows current track with album art
- [x] **SPOT-04**: User can play/pause/skip from the homepage
- [x] **SPOT-05**: Auto-rotate picks random song at configurable interval
- [x] **SPOT-06**: User can search and add songs via Spotify Search API
- [x] **SPOT-07**: User can view and manage playlist (remove tracks)
- [x] **SPOT-08**: Recently played songs are not repeated
- [x] **SPOT-09**: Token refresh happens automatically
- [x] **SPOT-10**: Feature degrades gracefully without Premium
...
| SPOT-08 | Phase 9 | Complete |
| SPOT-09 | Phase 9 | Complete |
| SPOT-10 | Phase 9 | Complete |
